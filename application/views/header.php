...
<script type="text/javascript" src="https://cdn.datatables.net/1.13.4/js/jquery.dataTables.min.js"></script>
    ...
    <div class="container-scroller">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
          <a class="sidebar-brand brand-logo" href="index.html"><img src="assets/images/logo.svg" alt="" />amor</a>
          <a class="sidebar-brand brand-logo-mini" href="index.html"><img src="assets/images/logo-mini.svg" alt="l" />logo</a>
        </div>
        <ul class="nav">
          ...
          <li class="nav-item menu-items">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="<?php echo site_url(); ?>/instructores/nuevo">Nuevo</a></li>
                <li class="nav-item"> <a class="nav-link" href="<?php echo site_url(); ?>/instructores/index">Listado</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item menu-items">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="<?php echo site_url(); ?>/cursos/nuevo">Nuevo</a></li>
                <li class="nav-item"> <a class="nav-link" href="<?php echo site_url(); ?>/cursos/listado">Listado</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item menu-items">
          ...
          <div class="navbar-menu-wrapper flex-grow d-flex align-items-stretch">
            ...
            <ul class="navbar-nav navbar-nav-right">
              <li class="nav-item dropdown d-none d-lg-block">
                <a class="nav-link btn btn-success create-new-button" id="createbuttonDropdown" data-toggle="dropdown" aria-expanded="false" href="#"> BIENVENIDO A NUESTRA PAGINA</a>
              ...
              <li class="nav-item dropdown">
                <a class="nav-link" id="profileDropdown" href="#" data-toggle="dropdown">
                  <div class="navbar-profile">
                      <img src=" <?php echo base_url(); ?>/assets/img/fotoma.png "  width="30px" height="30px" alt="">
                    <p class="mb-0 d-none d-sm-block navbar-profile-name"> <?php echo $this->session->userdata("conectado")->email_usu; ?></p>
  ...
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="<?php echo site_url();?>">CURSOS UTC</a>
    </div>
      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a href="<?php echo site_url(); ?>/cursos/listado">LISTADO</a></li>
          </ul>
        </li>
      </ul>
